...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (urlError === 'auth_callback_failed') {
      setError('Google sign-in failed. Check that your Supabase anon key and Google provider are configured correctly.');
    } else if (urlError) {
      setError(urlError);
    }
  }, []);
  ...
  async function handleGoogleLogin() {
    ...
    // If no error, browser navigates away — no need to setLoading(false)
  }
