# Fetch the JIRA ID and Create a Test Plan Strategy Buddy
# KAN-4-> Fetch Test Plan
...
You will be able to create a test plan Strategy based on the by fetching the KAN-4 automatically. @chapter_03_BLAST_FW/B.L.A.S.T.md  

GROQ - openai/gpt-oss-120b (FREE)
fETCH JIRA -> emAIL, token, JIRA - KAN-4